...
import TronLogo from "../assets/chains/tron-trx-logo.png";
...
export const chains: Chains = {
  [1]: {
    chainId: utils.hexValue(424242),
    rpcUrls: ["https://eth.bd.evmos.org:8545"],
    chainName: "Tron",
    label: "Connect to Tron Network",
    nativeCurrency: {
      name: "TRX",
      symbol: "TRX",
      decimals: 18,
    ...
    blockExplorerUrls: [""],
    exampleContractAddress: "TQQXQkS6qbAGkmYTukNmiddZMH6zLSwvgi",
    contractExplorerUrl:
      "https://nile.tronscan.org/#/contract/TQQXQkS6qbAGkmYTukNmiddZMH6zLSwvgi/code",
    logo: TronLogo,
  },
  // [9001]: {
